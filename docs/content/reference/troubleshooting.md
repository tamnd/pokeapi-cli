...
Most of these come down to network reality or how pokeapi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

pokeapi rate-limits like any public site. pokeapi already paces
...
Where a surface is gated, pokeapi reads a cookie or token you supply
...
`pokeapi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what pokeapi actually did
