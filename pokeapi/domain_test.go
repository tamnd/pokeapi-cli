...
// HTTP behaviour is covered in pokeapi_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "pokeapi://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("pokeapi", "about")
	if err != nil || got.String() != "pokeapi://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want pokeapi://page/about", got.String(), err)
	}
}
